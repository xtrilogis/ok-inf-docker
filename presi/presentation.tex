...
\begin{frame}[t]
    ...
    \end{figure}
    \pause
    \href{https://www.docker.com/company/newsroom/media-resources/}{Offizielle Logo Guide Line}
...
\begin{frame}
    ...
    \begin{description}[labelindent=0.5cm, style=unboxed, labelwidth=\widthof{-\,-mount mountm}, leftmargin=!]
        ...
        \item[\desclabel{-p [host]:[port]}] Port(s) veröffentlichen (\small Hostport:Containerport)
